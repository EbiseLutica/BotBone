...
namespace BotBone.Misskey
{
	...
	public class Shell : IShell
	{
		...
		public Core.Api.AttachmentType AttachmentType => BotBone.Core.Api.AttachmentType.UploadAndAttach;
		...
		{
			var app = await mi.App.CreateAsync("BotBone for Misskey", "Kawaii Bot Framework", ((Permission[])Enum.GetValues(typeof(Permission))).Select(p => p.ToStr()).ToArray(), "http://xeltica.work");
