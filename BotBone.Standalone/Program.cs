	...
	class Program
	{
		...
		static async Task Main()
		{
			...
			while (true)
			{
				...
				var post = new Post(UserStore.You, UserStore.BotBone, text);
...
#pragma warning restore CS4014
	...
	{
		public IUser Myself => UserStore.BotBone;
		...
		{
			return id == UserStore.BotBone.Id ? UserStore.BotBone : id == UserStore.You.Id ? UserStore.You : null;
		}

		public async Task<IUser?> GetUserByNameAsync(string name)
		{
			name = name.ToLowerInvariant();
			return name == UserStore.BotBone.Name ? UserStore.BotBone : name == UserStore.You.Name ? UserStore.You : null;
		}
	...
	{
		public static IUser BotBone = new User
		{
			Id = "0",
			Name = "BotBone",
			ScreenName = "BotBone",
